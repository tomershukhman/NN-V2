...
# Training thresholds
TRAIN_CONFIDENCE_THRESHOLD = 0.35  # Lowered from 0.45 to keep more candidates
TRAIN_NMS_THRESHOLD = 0.7  # Increased from 0.6 to allow more overlapping boxes during training

# Inference thresholds
CONFIDENCE_THRESHOLD = 0.25  # Lowered to catch more valid detections
NMS_THRESHOLD = 0.5  # Slightly increased to allow some overlap
MAX_DETECTIONS = 15  # Increased to allow more simultaneous detections
