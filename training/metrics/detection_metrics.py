    ...
    def calculate_metrics(predictions, targets):
        ...
        for pred, target in zip(predictions, targets):
            ...
            if num_pred == 0:
                ...
                # Skip IoU calculation if either boxes tensor is empty
                ...
                try:
                    ...
                    print(f"Warning: Error computing IoU. Pred boxes shape: {pred_boxes.shape}, GT boxes shape: {gt_boxes.shape}")
                    continue
